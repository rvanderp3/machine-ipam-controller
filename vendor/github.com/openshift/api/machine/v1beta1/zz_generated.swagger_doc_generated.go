...
var map_AddressesFromPool = map[string]string{
	...
	"resource": "Kind is the type of resource being referenced",
...
var map_NetworkDeviceSpec = map[string]string{
	...
	"deviceName":        "DeviceName may be used to explicitly assign a name to the network device as it exists in the guest operating system.",
	"dhcp4":             "DHCP4 is a flag that indicates whether or not to use DHCP for IPv4 on this device. If enabled, then IPAddrs should not contain any IPv4 addresses and AddressesFromPools must be empty.",
	"dhcp6":             "DHCP6 is a flag that indicates whether or not to use DHCP for IPv6 on this device. If enabled, then IPAddrs should not contain any IPv6 addresses and AddressesFromPools must be empty.",
	"gateway4":          "Gateway4 is the IPv4 gateway used by this device. Required when DHCP4 is false.",
	"gateway6":          "Gateway4 is the IPv4 gateway used by this device. Required when DHCP6 is false.",
	"ipAddrs":           "IPAddrs is a list of one or more IPv4 and/or IPv6 addresses and CIDR to assign to this device.  For example: 192.168.1.100/24 Required when DHCP4 and DHCP6 are both Disabled.",
	"mtu":               "MTU is the device’s Maximum Transmission Unit size in bytes. https://www.rfc-editor.org/rfc/rfc791",
	"macAddr":           "MACAddr is the MAC address used by this device. It is generally a good idea to omit this field and allow a MAC address to be generated. Please note that this value must use the VMware OUI to work with the in-tree vSphere cloud provider.",
	"nameservers":       "Nameservers is a list of IPv4 and/or IPv6 addresses used as DNS nameservers. Please note that Linux allows only three nameservers (https://linux.die.net/man/5/resolv.conf).",
	"routes":            "Routes is a list of optional, static routes applied to the device.",
	"searchDomains":     "SearchDomains is a list of search domains used when resolving IP addresses with DNS.",
	"addressesFromPool": "AddressesFromPools is a list of references to IP pool types and instances which are handled by an external controller.  The external controller will assign IP addresses in accordance with the IP pool instances.",
}
...
var map_NetworkRouteSpec = map[string]string{
	"":       "NetworkRouteSpec defines a static network route.",
	"to":     "To is an IPv4 or IPv6 address of the target network.",
	"via":    "Via is the IPv4 or IPv6 address of the gateway.",
	"metric": "Metric is the weight/priority of the route.",
}

func (NetworkRouteSpec) SwaggerDoc() map[string]string {
	return map_NetworkRouteSpec
}
