...
type SharedInformerFactory interface {
	...
	Ipamcontroller() ipamcontrolleropenshiftio.Interface
}

func (f *sharedInformerFactory) Ipamcontroller() ipamcontrolleropenshiftio.Interface {
	return ipamcontrolleropenshiftio.New(f, f.namespace, f.tweakListOptions)
}
