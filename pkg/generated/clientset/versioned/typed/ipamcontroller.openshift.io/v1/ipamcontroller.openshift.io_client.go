...
import (
	...
	"github.com/openshift-splat-team/machine-ipam-controller/pkg/generated/clientset/versioned/scheme"
	rest "k8s.io/client-go/rest"
)

type IpamcontrollerV1Interface interface {
...
// NewForConfig creates a new IpamcontrollerV1Client for the given config.
...
// NewForConfigAndClient creates a new IpamcontrollerV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*IpamcontrollerV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &IpamcontrollerV1Client{client}, nil
}

// NewForConfigOrDie creates a new IpamcontrollerV1Client for the given config and
...
func New(c rest.Interface) *IpamcontrollerV1Client {
	return &IpamcontrollerV1Client{c}
}
